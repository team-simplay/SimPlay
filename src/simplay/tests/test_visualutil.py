...
class TestVisualBasicUtil:
    def test_set_visible(self):
        ...
        with pytest.raises(TypeError,
                           match="component must be a VisualComponent"):
    ...
    def test_set_not_interacting(self):
        ...
        assert manager.events[0].action == "SET_NOT_INTERACTING"
    ...
    def test_set_decorating_text(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "SET_DECORATING_TEXT"
    ...
    def test_set_sprite_frame(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "SET_SPRITE_FRAME"
...
class TestResourceVisualUtil:
    def test_set_capacity(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "RESOURCE.SET_CAPACITY"
    ...
    def test_set_utilization(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "RESOURCE.SET_UTILIZATION"
...
class TestContainerVisualUtil:
    def test_set_capacity(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "CONTAINER.SET_CAPACITY"
        assert manager.events[0].args == {"capacity": 0}
    ...
    def test_set_level(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "CONTAINER.SET_LEVEL"
...
class TestStoreVisualUtil:
    def test_set_capacity(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "STORE.SET_CAPACITY"
        assert manager.events[0].args == {"capacity": 0}
    ...
    def test_set_content(self):
        ...
        assert manager.events[0].for_id == "id"
        assert manager.events[0].timestamp == 0
        assert manager.events[0].action == "STORE.SET_CONTENT"
