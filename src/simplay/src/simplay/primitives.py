...
class ErrorText:
    ...
    COMPONENT_MUST_BE_VISUAL_COMPONENT = "Component must be of type VisualComponent."
    ...
    CAPACITY_MUST_BE_POSITIVE_INT_OR_FLOAT = "Capacity must be a positive integer or float."
    ...
    X_OFFSET_OUT_OF_BOUNDS = "x added to width must be less than or equal to cols"
    Y_MUST_BE_INT = "y must be an integer."
    Y_OUT_OF_BOUNDS = "y must be between 0 and rows"
    Y_OFFSET_OUT_OF_BOUNDS = "y added to height must be less than or equal to rows"
    ...
    LEVEL_MUST_BE_POSITIVE_INT_OR_FLOAT = "Level must be a positive integer or float."
